...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.3/HyperPayU.zip",
            checksum: "f358ac57585abc7b0f1922932e120d64b5acdeeec66a6b9ff9e1655bcef5c756"
        ),
        .target(

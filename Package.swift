...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.5.7/HyperPayU.zip",
            checksum: "26ba331e10a639bafac2586c53147f9c3880fe9007d79e39e7b7bbc77ae32499"
        ),
        .target(

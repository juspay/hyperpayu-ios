...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.6/HyperPayU.zip",
            checksum: "77ad0efe5e7625c96aeb965b76311da0860e48b017eb30a50129307013baed7a"
        ),
        .target(

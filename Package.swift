...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.1.13/HyperPayU.zip",
            checksum: "ee20628db5abd664423f37090ceec3ff28142a352f7b2cbaf71f69302f553fc3"
        ),
        .target(

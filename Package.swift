...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.7/HyperPayU.zip",
            checksum: "f8d30bc577a8f47811886ab6485b30bca8020c6f587798fe1695dca571f9168a"
        ),
        .target(

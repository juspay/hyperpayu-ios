...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.6.4/HyperPayU.zip",
            checksum: "156db702a4dbbc60923bad1f728e41eceda3b609f6d239091d1ba86847a67624"
        ),
        .target(

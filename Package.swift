...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.5.3/HyperPayU.zip",
            checksum: "ce0893fa8cc66f0f2d9566981f32f7e13106408f661115ba480d68e178b31cae"
        ),
        .target(

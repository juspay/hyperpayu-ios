...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.4/HyperPayU.zip",
            checksum: "d5d6a9a9693ab43165b853e79c6b925f594bce1b7a9f5f943bbcc22413c3f270"
        ),
        .target(

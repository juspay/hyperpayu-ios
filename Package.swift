...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.6.7/HyperPayU.zip",
            checksum: "5da1d9414792ae995f50d07c19971349093fecfb7c6b1aa94033718bd89d4005"
        ),
        .target(

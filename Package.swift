...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.5.10/HyperPayU.zip",
            checksum: "c9266fa1eb98941c813b7f86e38be822aee201791aea13eb72bd4b4b0f8350d6"
        ),
        .target(

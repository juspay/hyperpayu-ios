...
let package = Package(
    ...
    targets: [
        .binaryTarget(
            name: "HyperPayU",
            url: "https://public.releases.juspay.in/release/ios/hyper-sdk/2.2.7.9/HyperPayU.zip",
            checksum: "5f5c1117c1e0c63508da4aea84ebea309538a426123b7ebe404dba7668716679"
        ),
        .target(
